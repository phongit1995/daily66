...
router.post("/find-history-agent-send",async(req,res)=>{
    try {
        ...
        const cookieCloudflare = await getCookieCloudflare();
        console.log(cookieCloudflare);
        const resultHistory = await findHistoryAgent(cookieCloudflare.cookie,cookieCloudflare.userArgent,userSend.cookie,timeNow,timeNow);
        //const resultHistory = await findHistoryAgentSend('__cfduid=d17850110bd2b097fb29753f8a17859bf1610703359; cf_clearance=ef15af2ef9c38fd1bad56480b4fc04c20459b68c-1610703359-0-150','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.97 Safari/537.36',userSend.cookie,fromdate,todate);
